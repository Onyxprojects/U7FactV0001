...
public class Factuur
{
    ...
    [Required(ErrorMessage = "Beschrijving is een verplicht veld")]// Van dit veld zou ik graag Omschrijving maken en het niet lager verplicht maken!! Dit dient enkel voor intern gebruik
